 ...
 */
@Entity(name = "IISFINALРасчетныйЛист")
...
public class RaschetnyjList {
    ...
    @Column(name = "ДатаЛиста")
    private Date даталиста;
    ...
    public Date getДатаЛиста() {
      return даталиста;
    }

    public void setДатаЛиста(Date даталиста) {
      this.даталиста = даталиста;
    }
